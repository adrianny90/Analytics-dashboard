"""S&P 500 constituent tickers (Yahoo-Finance-safe symbols; dual-class
shares like BRK.B use the hyphenated form BRK-B) mapped to their GICS
sector, used only by the S&P 500 ranking feature - independent of the
hand-curated dashboard watchlist in symbols.py.

Sourced from https://github.com/datasets/s-and-p-500-companies
(cross-checked against Wikipedia's List of S&P 500 companies), snapshot
taken 2026-09-16. Constituents change over time (additions/removals,
ticker changes from spin-offs) - this list will drift; nothing here is
loaded live to keep the ranking run reproducible and rate-limit-friendly.
"""
...
SP500_SYMBOLS: list[str] = list(SP500_SECTORS.keys())
